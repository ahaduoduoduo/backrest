...
export const EXCLUDE_PRESETS: ExcludePreset[] = [
  ...
  },
  {
    ...
    title: {
      zh: "日志、缓存和依赖下载",
      en: "Logs, caches, and downloaded dependencies",
    },
    description: {
      zh: "跳过可重新生成的日志、临时文件、Node 依赖和包缓存。",
      en: "Omits regenerable logs, temporary files, Node dependencies, and package caches.",
    },
  },
  {
    id: "git-history",
